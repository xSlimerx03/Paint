...
public class EX8_10FigurasMejor extends JPanel {
    ...
    public static JPanel createWrappedPanel() {
        ...
        wrapper.add(new EX8_10FigurasMejor(), BorderLayout.CENTER);
        return wrapper;
    }
}